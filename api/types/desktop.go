...
func (d *WindowsDesktopV3) CheckAndSetDefaults() error {
	...
	if d.Spec.ScreenSize != nil {
		if d.Spec.ScreenSize.Width > MaxRDPScreenWidth {
			d.Spec.ScreenSize.Width = MaxRDPScreenWidth
		}
		if d.Spec.ScreenSize.Height > MaxRDPScreenHeight {
			d.Spec.ScreenSize.Height = MaxRDPScreenHeight
		}
	}
