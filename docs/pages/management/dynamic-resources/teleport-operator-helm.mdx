---
title: Kubernetes Operator for Helm-deployed clusters
description: Enable the operator in your existing Teleport cluster deployed via the Helm chart.
---
...
[the guide for remote Teleport clusters](./teleport-operator-standalone.mdx) instead.
